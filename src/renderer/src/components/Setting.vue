            ...
            <div v-if="menu == 'theme'" class="setting-themes">
                ...
                <div class="theme-box">
                    <div :class="theme == 'default' ? 'theme active' : 'theme'" data-value="default" @click="onSwitchTheme">
                        ...
                        <div><i :class="theme == 'default' ? 'iconfont icon-radio-box-fill' : 'iconfont icon-unselected'"> </i><em>{{t('setting.theme.default')}}</em></div>
                    </div>
                    ...
                    <div :class="theme == 'light' ? 'theme active' : 'theme'" data-value="light" @click="onSwitchTheme">
                        ...
                        <div><i :class="theme == 'light' ? 'iconfont icon-radio-box-fill' : 'iconfont icon-unselected'"></i><em>{{t('setting.theme.light')}}</em></div>
                    </div>
                    <div :class="theme == 'dark' ? 'theme active' : 'theme'" data-value="dark" @click="onSwitchTheme">
                        ...
                        <div><i :class="theme == 'dark' ? 'iconfont icon-radio-box-fill' : 'iconfont icon-unselected'"></i><em>{{t('setting.theme.dark')}}</em></div>
                    </div>
                </div>
            </div>
